...
func (inst *DecreaseLiquidityV2) SetAmount0Min(amount_0_min uint64) *DecreaseLiquidityV2 {
	inst.Amount0Min = &amount_0_min
	return inst
}

// SetAmount1Min sets the "amount_1_min" parameter.
func (inst *DecreaseLiquidityV2) SetAmount1Min(amount_1_min uint64) *DecreaseLiquidityV2 {
...
func (inst *DecreaseLiquidityV2) SetProtocolPositionAccount(protocolPosition ag_solanago.PublicKey) *DecreaseLiquidityV2 {
	inst.AccountMetaSlice[4] = ag_solanago.Meta(protocolPosition)
	return inst
}
			...
			programBranch.Child(ag_format.Instruction("DecreaseLiquidityV2")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=16]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("             vault_0_mint", inst.AccountMetaSlice.Get(14)))
						accountsBranch.Child(ag_format.Meta("             vault_1_mint", inst.AccountMetaSlice.Get(15)))
					})
				})
		})
}
