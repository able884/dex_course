...
type OperationStateAccount struct {
	// Bump to identify PDA
	Bump uint8
...
var OperationStateAccountDiscriminator = [8]byte{19, 236, 58, 237, 81, 222, 183, 252}

func (obj OperationStateAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(OperationStateAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `Bump` param:
...
func (obj *OperationStateAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(OperationStateAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
type PersonalPositionStateAccount struct {
	// Bump to identify PDA
	Bump [1]uint8
...
var PersonalPositionStateAccountDiscriminator = [8]byte{70, 111, 150, 126, 230, 15, 25, 117}

func (obj PersonalPositionStateAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(PersonalPositionStateAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `Bump` param:
...
func (obj *PersonalPositionStateAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(PersonalPositionStateAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
type ProtocolPositionStateAccount struct {
	// Bump to identify PDA
	Bump uint8
...
var ProtocolPositionStateAccountDiscriminator = [8]byte{100, 226, 145, 99, 146, 218, 160, 106}

func (obj ProtocolPositionStateAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(ProtocolPositionStateAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `Bump` param:
...
func (obj *ProtocolPositionStateAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(ProtocolPositionStateAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
type SupportMintAssociatedAccount struct {
	// Bump to identify PDA
	Bump uint8
...
var SupportMintAssociatedAccountDiscriminator = [8]byte{134, 40, 183, 79, 12, 112, 162, 53}

func (obj SupportMintAssociatedAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(SupportMintAssociatedAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `Bump` param:
...
func (obj *SupportMintAssociatedAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(SupportMintAssociatedAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
type TickArrayBitmapExtensionAccount struct {
	PoolId ag_solanago.PublicKey
...
var TickArrayBitmapExtensionAccountDiscriminator = [8]byte{60, 150, 36, 219, 97, 128, 139, 153}

func (obj TickArrayBitmapExtensionAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(TickArrayBitmapExtensionAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `PoolId` param:
...
func (obj *TickArrayBitmapExtensionAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(TickArrayBitmapExtensionAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
...
type TickArrayStateAccount struct {
	PoolId               ag_solanago.PublicKey
...
var TickArrayStateAccountDiscriminator = [8]byte{192, 155, 85, 205, 49, 249, 129, 42}

func (obj TickArrayStateAccount) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	// Write account discriminator:
	err = encoder.WriteBytes(TickArrayStateAccountDiscriminator[:], false)
	if err != nil {
		return err
	}
	// Serialize `PoolId` param:
...
func (obj *TickArrayStateAccount) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
	// Read and check account discriminator:
	{
		discriminator, err := decoder.ReadTypeID()
		if err != nil {
		...
		if !discriminator.Equal(TickArrayStateAccountDiscriminator[:]) {
			return fmt.Errorf(
				"wrong discriminator: wanted %s, got %s",
