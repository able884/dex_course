...
func (inst *Withdraw) SetMinimumToken0Amount(minimum_token_0_amount uint64) *Withdraw {
	inst.MinimumToken0Amount = &minimum_token_0_amount
	return inst
}

// SetMinimumToken1Amount sets the "minimum_token_1_amount" parameter.
func (inst *Withdraw) SetMinimumToken1Amount(minimum_token_1_amount uint64) *Withdraw {
...
func (inst *Withdraw) findFindAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *Withdraw) FindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindAuthorityAddress(bumpSeed)
	return
}

func (inst *Withdraw) MustFindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Withdraw) FindAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindAuthorityAddress(0)
	return
}

func (inst *Withdraw) MustFindAuthorityAddress() (pda ag_solanago.PublicKey) {
