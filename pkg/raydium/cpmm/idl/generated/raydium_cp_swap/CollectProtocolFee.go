...
func (inst *CollectProtocolFee) SetAmount0Requested(amount_0_requested uint64) *CollectProtocolFee {
	inst.Amount0Requested = &amount_0_requested
	return inst
}

// SetAmount1Requested sets the "amount_1_requested" parameter.
func (inst *CollectProtocolFee) SetAmount1Requested(amount_1_requested uint64) *CollectProtocolFee {
...
func (inst *CollectProtocolFee) findFindAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *CollectProtocolFee) FindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindAuthorityAddress(bumpSeed)
	return
}

func (inst *CollectProtocolFee) MustFindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *CollectProtocolFee) FindAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindAuthorityAddress(0)
	return
}

func (inst *CollectProtocolFee) MustFindAuthorityAddress() (pda ag_solanago.PublicKey) {
