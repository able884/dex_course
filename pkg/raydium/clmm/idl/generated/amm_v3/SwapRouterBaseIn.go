...
func NewSwapRouterBaseInInstructionBuilder() *SwapRouterBaseIn {
	...
	nd.AccountMetaSlice[5] = ag_solanago.Meta(Addresses["MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr"])
	return nd
}
			...
			programBranch.Child(ag_format.Instruction("SwapRouterBaseIn")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=6]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("token_program_2022", inst.AccountMetaSlice.Get(4)))
