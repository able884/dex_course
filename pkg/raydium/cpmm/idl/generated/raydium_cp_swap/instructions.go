...
var ProgramID ag_solanago.PublicKey = ag_solanago.MustPublicKeyFromBase58("6Phx6fHxjmyXLpqFdPgSwe8VkCnaBX2FMH3ZHchGHvA2")
...
var (
	...
	//
	Instruction_ClosePermissionPda = ag_binary.TypeID([8]byte{156, 84, 32, 118, 69, 135, 70, 123})
	...
	// * `ctx`- The context of accounts
	//
	Instruction_CreatePermissionPda = ag_binary.TypeID([8]byte{135, 136, 2, 216, 137, 169, 181, 202})
	...
	//
	Instruction_InitializeWithPermission = ag_binary.TypeID([8]byte{63, 55, 254, 65, 49, 178, 89, 121})
...
func InstructionIDToName(id ag_binary.TypeID) string {
	switch id {
	case Instruction_ClosePermissionPda:
		return "ClosePermissionPda"
	...
	case Instruction_CreatePermissionPda:
		return "CreatePermissionPda"
	case Instruction_Deposit:
		return "Deposit"
	case Instruction_Initialize:
		return "Initialize"
	case Instruction_InitializeWithPermission:
		return "InitializeWithPermission"
...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		{
			Name: "close_permission_pda", Type: (*ClosePermissionPda)(nil),
		},
		{
		...
		{
			Name: "create_permission_pda", Type: (*CreatePermissionPda)(nil),
		},
		{
		...
		{
			Name: "initialize_with_permission", Type: (*InitializeWithPermission)(nil),
		},
		{
