...
func (inst *Deposit) SetMaximumToken0Amount(maximum_token_0_amount uint64) *Deposit {
	inst.MaximumToken0Amount = &maximum_token_0_amount
	return inst
}

// SetMaximumToken1Amount sets the "maximum_token_1_amount" parameter.
func (inst *Deposit) SetMaximumToken1Amount(maximum_token_1_amount uint64) *Deposit {
...
func (inst *Deposit) findFindAuthorityAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
...
func (inst *Deposit) FindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindAuthorityAddress(bumpSeed)
	return
}

func (inst *Deposit) MustFindAuthorityAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindAuthorityAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Deposit) FindAuthorityAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindAuthorityAddress(0)
	return
}

func (inst *Deposit) MustFindAuthorityAddress() (pda ag_solanago.PublicKey) {
