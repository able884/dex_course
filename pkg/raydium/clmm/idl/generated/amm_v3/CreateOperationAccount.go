...
func (inst *CreateOperationAccount) findFindOperationStateAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: operation
...
func (inst *CreateOperationAccount) FindOperationStateAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindOperationStateAddress(bumpSeed)
	return
}

func (inst *CreateOperationAccount) MustFindOperationStateAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindOperationStateAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *CreateOperationAccount) FindOperationStateAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindOperationStateAddress(0)
	return
}

func (inst *CreateOperationAccount) MustFindOperationStateAddress() (pda ag_solanago.PublicKey) {
