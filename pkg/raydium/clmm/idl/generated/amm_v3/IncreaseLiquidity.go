...
func (inst *IncreaseLiquidity) SetAmount0Max(amount_0_max uint64) *IncreaseLiquidity {
	inst.Amount0Max = &amount_0_max
	return inst
}

// SetAmount1Max sets the "amount_1_max" parameter.
func (inst *IncreaseLiquidity) SetAmount1Max(amount_1_max uint64) *IncreaseLiquidity {
