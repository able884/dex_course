...
func (inst *Initialize) SetInitAmount0(init_amount_0 uint64) *Initialize {
	inst.InitAmount0 = &init_amount_0
	return inst
}

// SetInitAmount1 sets the "init_amount_1" parameter.
func (inst *Initialize) SetInitAmount1(init_amount_1 uint64) *Initialize {
...
func (inst *Initialize) findFindLpMintAddress(poolState ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: pool_lp_mint
...
func (inst *Initialize) FindLpMintAddressWithBumpSeed(poolState ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindLpMintAddress(poolState, bumpSeed)
	return
}

func (inst *Initialize) MustFindLpMintAddressWithBumpSeed(poolState ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindLpMintAddress(poolState, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Initialize) FindLpMintAddress(poolState ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindLpMintAddress(poolState, 0)
	return
}

func (inst *Initialize) MustFindLpMintAddress(poolState ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
...
func (inst *Initialize) findFindCreatorLpTokenAddress(creator ag_solanago.PublicKey, lpMint ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// path: creator
...
func (inst *Initialize) FindCreatorLpTokenAddressWithBumpSeed(creator ag_solanago.PublicKey, lpMint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindCreatorLpTokenAddress(creator, lpMint, bumpSeed)
	return
}

func (inst *Initialize) MustFindCreatorLpTokenAddressWithBumpSeed(creator ag_solanago.PublicKey, lpMint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindCreatorLpTokenAddress(creator, lpMint, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Initialize) FindCreatorLpTokenAddress(creator ag_solanago.PublicKey, lpMint ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindCreatorLpTokenAddress(creator, lpMint, 0)
	return
}

func (inst *Initialize) MustFindCreatorLpTokenAddress(creator ag_solanago.PublicKey, lpMint ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
...
func (inst *Initialize) findFindToken0VaultAddress(poolState ag_solanago.PublicKey, token0Mint ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: pool_vault
...
func (inst *Initialize) FindToken0VaultAddressWithBumpSeed(poolState ag_solanago.PublicKey, token0Mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindToken0VaultAddress(poolState, token0Mint, bumpSeed)
	return
}

func (inst *Initialize) MustFindToken0VaultAddressWithBumpSeed(poolState ag_solanago.PublicKey, token0Mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindToken0VaultAddress(poolState, token0Mint, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Initialize) FindToken0VaultAddress(poolState ag_solanago.PublicKey, token0Mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindToken0VaultAddress(poolState, token0Mint, 0)
	return
}

func (inst *Initialize) MustFindToken0VaultAddress(poolState ag_solanago.PublicKey, token0Mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
...
func (inst *Initialize) findFindToken1VaultAddress(poolState ag_solanago.PublicKey, token1Mint ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: pool_vault
	seeds = append(seeds, []byte{byte(0x70), byte(0x6f), byte(0x6f), byte(0x6c), byte(0x5f), byte(0x76), byte(0x61), byte(0x75), byte(0x6c), byte(0x74)})
	// path: poolState
...
func (inst *Initialize) FindToken1VaultAddressWithBumpSeed(poolState ag_solanago.PublicKey, token1Mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindToken1VaultAddress(poolState, token1Mint, bumpSeed)
	return
}

func (inst *Initialize) MustFindToken1VaultAddressWithBumpSeed(poolState ag_solanago.PublicKey, token1Mint ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindToken1VaultAddress(poolState, token1Mint, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Initialize) FindToken1VaultAddress(poolState ag_solanago.PublicKey, token1Mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindToken1VaultAddress(poolState, token1Mint, 0)
	return
}

func (inst *Initialize) MustFindToken1VaultAddress(poolState ag_solanago.PublicKey, token1Mint ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
...
func (inst *Initialize) findFindObservationStateAddress(poolState ag_solanago.PublicKey, knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: observation
...
func (inst *Initialize) FindObservationStateAddressWithBumpSeed(poolState ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindObservationStateAddress(poolState, bumpSeed)
	return
}

func (inst *Initialize) MustFindObservationStateAddressWithBumpSeed(poolState ag_solanago.PublicKey, bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindObservationStateAddress(poolState, bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *Initialize) FindObservationStateAddress(poolState ag_solanago.PublicKey) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindObservationStateAddress(poolState, 0)
	return
}

func (inst *Initialize) MustFindObservationStateAddress(poolState ag_solanago.PublicKey) (pda ag_solanago.PublicKey) {
