...
func NewUpdateOperationAccountInstructionBuilder() *UpdateOperationAccount {
	...
	nd.AccountMetaSlice[0] = ag_solanago.Meta(Addresses["Egn9AWQrkstM4NJv2g8rqLfxiYdgFWLr2UxrsrvSRCQZ"]).SIGNER()
...
func (inst *UpdateOperationAccount) findFindOperationStateAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: operation
...
func (inst *UpdateOperationAccount) FindOperationStateAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindOperationStateAddress(bumpSeed)
	return
}

func (inst *UpdateOperationAccount) MustFindOperationStateAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindOperationStateAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *UpdateOperationAccount) FindOperationStateAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindOperationStateAddress(0)
	return
}

func (inst *UpdateOperationAccount) MustFindOperationStateAddress() (pda ag_solanago.PublicKey) {
