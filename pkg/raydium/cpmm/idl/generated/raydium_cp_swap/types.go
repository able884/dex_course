...
type CreatorFeeOn ag_binary.BorshEnum

const (
	CreatorFeeOnBothToken CreatorFeeOn = iota
	CreatorFeeOnOnlyToken0
	CreatorFeeOnOnlyToken1
)
...
func (obj Permission) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
...
func (obj *Permission) UnmarshalWithDecoder(decoder *ag_binary.Decoder) (err error) {
...
func (obj SwapEvent) MarshalWithEncoder(encoder *ag_binary.Encoder) (err error) {
	...
	// Serialize `CreatorFeeOnInput` param:
