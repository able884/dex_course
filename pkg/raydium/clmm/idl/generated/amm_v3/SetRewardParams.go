...
func (inst *SetRewardParams) findFindOperationStateAddress(knownBumpSeed uint8) (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	var seeds [][]byte
	// const: operation
...
func (inst *SetRewardParams) FindOperationStateAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey, err error) {
	pda, _, err = inst.findFindOperationStateAddress(bumpSeed)
	return
}

func (inst *SetRewardParams) MustFindOperationStateAddressWithBumpSeed(bumpSeed uint8) (pda ag_solanago.PublicKey) {
	pda, _, err := inst.findFindOperationStateAddress(bumpSeed)
	if err != nil {
		panic(err)
	}
...
func (inst *SetRewardParams) FindOperationStateAddress() (pda ag_solanago.PublicKey, bumpSeed uint8, err error) {
	pda, bumpSeed, err = inst.findFindOperationStateAddress(0)
	return
}

func (inst *SetRewardParams) MustFindOperationStateAddress() (pda ag_solanago.PublicKey) {
			...
			programBranch.Child(ag_format.Instruction("SetRewardParams")).
				...
				ParentFunc(func(instructionBranch ag_treeout.Branches) {
					...
					instructionBranch.Child("Accounts[len=6]").ParentFunc(func(accountsBranch ag_treeout.Branches) {
						...
						accountsBranch.Child(ag_format.Meta("token_program_2022", inst.AccountMetaSlice.Get(5)))
					})
				})
		})
}
