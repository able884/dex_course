...
var (
	...
	ErrInsufficientVault = &customErrorDef{
		code: 6012,
		msg:  "Insufficient vault",
		name: "InsufficientVault",
	}
	ErrInvalidFeeModel = &customErrorDef{
		code: 6013,
		msg:  "Invalid fee model",
		name: "InvalidFeeModel",
	}
	ErrNoFeeCollect = &customErrorDef{
		code: 6014,
		msg:  "Fee is zero",
		name: "NoFeeCollect",
	}
	Errors = map[int]CustomError{
		...
		6011: ErrMathOverflow,
		6012: ErrInsufficientVault,
		6013: ErrInvalidFeeModel,
		6014: ErrNoFeeCollect,
	}
)
