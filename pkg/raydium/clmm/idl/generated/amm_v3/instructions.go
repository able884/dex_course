...
var ProgramID ag_solanago.PublicKey = ag_solanago.MustPublicKeyFromBase58("GodmWN2QXikut2nwHuFGpCPeN6nBb2vuCFknVy3edxVw")
...
var (
	...
	// * `ctx` - The context of accounts
	//
	Instruction_CloseProtocolPosition = ag_binary.TypeID([8]byte{201, 117, 152, 144, 85, 85, 108, 178})
...
func InstructionIDToName(id ag_binary.TypeID) string {
	...
	case Instruction_CloseProtocolPosition:
		return "CloseProtocolPosition"
...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		...
		{
			Name: "close_protocol_position", Type: (*CloseProtocolPosition)(nil),
		},
		{
